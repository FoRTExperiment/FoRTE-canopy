...
The code below outlines the ranodmization procedure for the disturbance treatment.
```{r write_output}
# first the plot assignments
plot.disturbance <- rbind(plot.disturbance.a, plot.disturbance.b, plot.disturbance.c, plot.disturbance.d)
write.csv(plot.disturbance, "./output/plot_disturbance_level_assignments.csv")

# then the treatment level assignments by group
plot.treatment <- rbind(group.a, group.b, group.c, group.d)
write.csv(plot.treatment, "./output/plot_treatment_level_assignments.csv")
```
